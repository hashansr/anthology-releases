...
## v0.718-rc.250926-1504 · 2026-09-25
- Fix: Reveal in Finder in Duplicate Tracks now works for files whose path contains an apostrophe, such as "Don't Fear" or "Sinead O'Connor".

## v0.717-rc.250926-1400 · 2026-09-25
- Fix: Changing a device's filename character rules in Scan Issues now only renames files whose names the rule actually changes. Files kept at an older path for other reasons (for example after an artist or album tag edit) are no longer offered as renames, and files whose names only look different because of how accented letters are stored are no longer moved.

## v0.716-rc.240926-2115 · 2026-09-24

## v0.715-rc.240926-2111 · 2026-09-24
- Fix: "Clear logs" in Settings > App > Logs now clears exactly what's currently filtered, including bulk edit history when the type filter is set to Bulk edit (previously bulk edit entries could never be cleared this way, even when explicitly filtered to). Clearing bulk edit history removes the ability to undo those specific edits, which is called out before you confirm. With no type filter selected, bulk edit history is still left alone by default.

## v0.714-rc.240926-1330 · 2026-09-24
- Fix: Settings > App > Logs no longer hides the filter controls when a filter matches nothing, so you're never stuck unable to change it back.
- Add: A "Clear logs" button in Settings > App > Logs clears library scan, device sync, and app warning history. Bulk edit history is kept separately so it can still be undone.
- Change: The Logs section in Settings > App moves to the bottom of the page and is collapsed by default.
- Change: Bulk edit and library scan error details now show the track's title, artist, album, and track number where available, instead of just an id or file path.
- Change: Clicking a row in Settings > App > Logs now opens a larger details view that fits more on screen and wraps long text instead of scrolling sideways.

## v0.713-rc.240926-0830 · 2026-09-24
- Add: New Settings > App > Logs section. Library scans, device syncs, bulk tag edits, and app warnings now show together in one filterable, sortable table with status colours, column show/hide/resize, and a details view for each entry.
- Add: Bulk tag edits (editing several tracks, a whole album, or renaming an artist) are now recorded with a pass/fail summary, matching CSV import.
- Add: App warnings and crashes (failed backups, failed device syncs, ReplayGain problems, iPod database write failures) are now recorded and visible in Settings > App > Logs instead of only appearing in the terminal.
- Change: The "Sync Logs" list on DAP and iPod device pages is replaced by a "View sync logs" button that opens the new unified Logs section, filtered to that device.
- Change: The "Scan history" list under Settings > Library is replaced by a "View scan logs" button that opens the new unified Logs section.

## v0.712-rc.230926-1429 · 2026-09-23
- Change: Character fixes in Scan Issues no longer edit the tags in your music files. Instead each device gets its own filename rules (for example ":" becomes " - "), which only change file and folder names on that device. Playlists exported to the device use the same names.
- Add: Songs already on a device are renamed in place when you change its filename rules, without copying them again.
- Change: The "Tags Updated" group in sync review is now "Updated", and also lists songs being renamed on the device.
- Remove: The Scan Issues option to rewrite tags in bulk. Earlier tag fixes can still be undone from Scan Issues.

## v0.711-rc.230926-1356 · 2026-09-23
- Critical: Fixed songs being copied to your device a second time after their tags or file locations changed. The old copy is now replaced instead of being left behind, and it is no longer offered to be copied back into your library.
- Change: When a song's tags change its file name on the device (for example after fixing characters in Scan Issues or renaming an artist), sync now moves it to the new name and removes the old copy once the new one is safely copied. These show under Tags Updated with the old file listed.
- Fix: Moving files with File Organisation no longer makes sync lose track of songs already on your devices, including iPods.
- Fix: Tag edits made in Anthology now reach the device even for songs that were first copied to it by another app.
- Change: Scan Issues now opens as a large window with wrapped text, so long file and album names are readable without scrolling sideways. Issue descriptions are shorter and each one says exactly which character or tag is the problem, with it highlighted.
- Add: Bulk character fixes in Scan Issues. For each character your device can't use in file names (like ":" or "/"), pick a replacement (for example ":" to " - "), preview the result, choose which tags to include, and fix them all at once.
- Add: Every bulk fix is logged in a Fix history list inside Scan Issues and can be undone in one click.
- Change: After applying or undoing a fix, the device is rescanned automatically and Scan Issues reopens with whatever is left.

## v0.710-rc.230926-1117 · 2026-09-23
- Fix: Scan Issues kept listing every song with a special character in its tags even after everything was already synced, with nothing left to do. Issues now only show up for songs actually part of the current sync.

## v0.709-rc.230926-1102 · 2026-09-23
- Fix: A sync warning about missing artist/album metadata could never actually appear, even when a track genuinely had no artist or album tag. It now correctly flags these.
- Add: Scan Issues rows now include a fix action. A row about a file with special characters or missing metadata gets an "Edit Tags" button that opens the real tag editor for that song, focused on the field that needs attention. A path collision between two songs gets an "Edit Tags" button for each side.
- Add: When the same Artist or Album Artist tag causes the special-character warning across many songs at once, those rows collapse into one with a "Rename Artist" shortcut that fixes every affected track in one action, instead of editing each song individually.

## v0.708-rc.230926-0933 · 2026-09-23
- Critical: Fixed a rare case where starting a device sync twice in quick succession (for example from two open windows) could corrupt a file on the device. Only one sync per device can start at a time now.
- Fix: A background sync status check could undo progress from an in-progress sync, making already-synced songs look out of sync again on the next scan.
- Fix: A sync that got stuck partway through (for example an unresponsive device) previously required restarting the whole app to clear. It can now be reset after about two minutes of no progress.
- Fix: Reopening Sync no longer throws away a completed scan you hadn't started yet. It now picks back up where you left off.
- Fix: A harmless file-attribute copy issue on some SD cards (exFAT-formatted) no longer marks a song that copied successfully as failed.
- Fix: The default Poweramp playlist folder now matches where Poweramp (and the in-app Help) actually expects playlists to be.
- Fix: Deleting a playlist no longer leaves orphaned export records behind on your DAPs.
- Add: The Sync wizard's scanning step now has a working Cancel button.
- Add: Sync now shows a warning banner if any files were skipped or renamed while scanning (for example, two songs mapping to the same destination path), with a "View all issues" table listing every affected file.
- Add: "Don't ask again" for a file on a device that isn't in your library, plus a way to view and restore anything you've ignored for that device.
- Add: Playlists can be skipped from a specific device's sync going forward, with a way to bring a skipped playlist back into rotation.

## v0.707-rc.230926-0837 · 2026-09-23
- Fix: Duplicate Tracks checkboxes (select all, select individual groups) were invisible due to a missing theme colour. They're visible again.
- Add: "Ignore" now works for duplicates found on a connected DAP, not just the local library, including a way to review and restore ignored groups per device.
- Add: A moving/deleting/ignoring duplicates action now shows a progress toast ("Moving to Trash 4/12", etc.) that keeps running and updating even if you navigate away from the Duplicate Tracks screen. Click it to jump back.

## v0.706-rc.220926-2220 · 2026-09-22
- Fix: Removing or moving duplicate tracks from a connected DAP now also removes any album/artist folders left empty and any matching lyrics (.lrc) file, matching what already happens for the local library.
- Add: Duplicate Tracks has a "Not a duplicate" action on each copy in a group, for tracks that were grouped together by mistake. Marked tracks show up under a new "Not Duplicate" panel with a Restore option.
- Fix: "Ignore" and "not a duplicate" decisions in Duplicate Tracks now stick across rescans, instead of silently resetting if a new matching copy shows up later.
- Fix: If a duplicate delete or move fails in the background after its 10-second Undo window closes (for example, a DAP was disconnected), you now see an error toast instead of the item silently staying untouched.
- Fix: Tracks with a duplicate blank tag left behind by a re-tagging tool (for example an empty Album or Year alongside the real value) were reading as blank instead of using the real value, both in the library scanner and the file import/organize preview.

## v0.705-rc.220926-2145 · 2026-09-22
- Fix: Removing or moving duplicate tracks now automatically removes any album/artist folders left empty, instead of leaving orphaned empty folders behind.

## v0.704-rc.220926-2049 · 2026-09-22
- Fix: Duplicate Tracks — "Scan for duplicates" is now disabled while sources are still loading.
- Fix: Duplicate Tracks — expanding a group's detail no longer jumps the page back to the top when the list is scrolled.

## v0.703-rc.220926-1910 · 2026-09-22
- Add: Duplicate Tracks has been rebuilt end to end. Pick a source (library or a connected player) and scan criteria first, then browse one dense row per duplicate group instead of a giant stacked table.
- Add: Each duplicate group now shows a recommended copy to keep, based on a configurable rule chain (bitrate, lossless format, filename pattern, path, size, newest, with shortest path as the tie-breaker) — editable from a "Keep rules" panel.
- Add: Search, folder filter, difference filter, and sort options for browsing large duplicate lists.
- Add: Select multiple duplicate groups at once and delete, move to a folder, or ignore them together, instead of one group at a time.
- Add: Every delete, move, or ignore action shows a 10-second Undo before anything actually happens on disk.
- Add: Optional "Audio fingerprint" matching finds duplicates with mismatched tags by comparing the actual audio content (requires chromaprint: `brew install chromaprint`).

## v0.702-rc.220926-1510 · 2026-09-22
- Fix: "Open in Finder" on a DAP duplicate now reveals the correct file instead of failing silently.
- Change: DAP duplicate scans are dramatically faster on repeat runs — only files that changed since the last scan are re-read.

## v0.701-rc.220926-1417 · 2026-09-22

## v0.700-rc.210926-2235 · 2026-09-21

## v0.699-rc.210926-2222 · 2026-09-21

## v0.698-rc.210926-2205 · 2026-09-21
- Critical: Fixed DAP duplicate detection (Settings > Duplicate detection > DAP) never finding any duplicates. It was comparing every device file against the wrong music folder, so every file failed silently and the scan always came back empty.

## v0.697-rc.210926-2155 · 2026-09-21

## v0.696-rc.210926-2141 · 2026-09-21

## v0.696-rc.210926-2136 · 2026-09-21

## v0.695-rc.210926-2124 · 2026-09-21

## v0.694-rc.210926-1926 · 2026-09-21

## v0.693-rc.210926-1920 · 2026-09-21

## v0.692-rc.210926-1814 · 2026-09-21
- Add: New Settings toggle, "Keep converted ALAC files after sync" (Data and backup section), lets you stop iPod sync from keeping a local cache of FLAC-to-ALAC conversions, freeing up disk space at the cost of re-converting tracks on every future sync. A "Clear Cache" button reclaims space already used by the cache.
- Add: Sync Logs — a "Sync Logs" section on each DAP and iPod's Gear detail page now shows the last 5 syncs for that device, including files added, updated (due to tag or content changes), removed, or failed (with the reason), plus playlist results, data transferred, and device space after the sync. Single-playlist "export to device" actions are logged too.
- Add: "View activity log" on the Sync wizard's final step now shows this same per-device sync history (not just the run that just finished), and is now also available on the iPod sync flow, which previously had no way to review a sync afterward.
- Add: Clicking "Update now" or the update-available notification now opens an "Update Anthology" summary first, showing what's changed since your current version before you download, instead of going straight to the download link.

## v0.691-rc.190926-1011 · 2026-09-19

## v0.690-rc.190926-0936 · 2026-09-19

## v0.689-rc.190926-0932 · 2026-09-19

## v0.688-rc.190926-0850 · 2026-09-19

## v0.687-rc.190926-0821 · 2026-09-19

## v0.686-rc.190926-0810 · 2026-09-19

## v0.685-rc.190926-0802 · 2026-09-19

## v0.684-rc.190926-0736 · 2026-09-19
- Change: The app is renamed from TuneBridge to Anthology — new app icon, window/menu titles, and macOS bundle identity (`com.anthology.app`). If you already have TuneBridge installed, your library, playlists, and settings are copied over automatically the first time you open Anthology; your old TuneBridge data and app are left untouched, so nothing is lost and you can remove TuneBridge yourself whenever you're ready.
- Change: The project's GitHub home moves from `hashansr/tunebridge` to `hashansr/anthology` (releases from `hashansr/tunebridge-releases` to `hashansr/anthology-releases`). Existing installs will keep finding updates automatically — nothing to do on your end.
- Fix: "Eject and disconnect" on the Sync wizard's final step actually ejects the device now, instead of just closing the wizard without ejecting anything.
- Fix: "View activity log" on the Sync wizard's final step now shows the full list of changes made during that sync, instead of navigating to unrelated listening history.
- Fix: The app window no longer flashes a bright white titlebar strip above the dark "Starting Anthology…" loading screen on launch (visible when macOS is in Light Mode) — the app's native chrome is now always pinned to dark, matching Anthology's own theme.
...
## v0.673-rc.160826-1411 · 2026-08-16

## v0.672-rc.140826-1534 · 2026-08-14
...
## v0.668-rc.140826-1201 · 2026-08-14

## v0.667-rc.140826-1145 · 2026-08-14
...
- Change: "Auto Play" is now "Continuous Play" throughout the player — it's been rebuilt on the same sonic-similarity engine as Genius Playlist, so what plays next is chosen by how it actually sounds compared to your recent listening, not just genre/energy matching. It now also builds a real session as you listen: it leans on the song that started your session early on, gradually lets the sound drift further as you keep accepting what it plays, snaps back toward something safer after a couple of skips, and never stacks more than two exploratory picks in a row.
- Remove: "AI Mix" and rule-based "Smart Playlists" have been retired now that Genius Playlist covers both use cases — building a mix from a seed song, or filtering by genre/year/format. Existing playlists created by either are untouched and still play normally; only the generation tools themselves are gone. The sidebar's "AI Mix" and "Smart Rules" quick-action buttons have also been removed.
...
## v0.647-rc.030826-2131 · 2026-08-03
...
## v0.635-rc.030826-0815 · 2026-08-03
...
- Fix: The bitrate reported for songs on a click-wheel iPod (and used by the device to size its playback buffer) was carried over unchanged from the original FLAC file even after transcoding to ALAC, so it could read far higher than the ALAC file's real bitrate, especially for hi-res sources - contributing to the stutter/skip issue above. It's now measured from the actual transcoded file, and that file is also correctly marked as variable-bitrate (how ALAC actually works) instead of constant-bitrate.
- Fix: Album art for click-wheel iPod sync was pulled independently from each individual song's own file tags, so songs on the same album could inconsistently end up with or without a cover depending on which files happened to have embedded art. It now reuses the same shared album art the rest of the app already shows consistently, falling back to the song's own file only if that's missing - and a song still missing art after both is now called out in the sync summary instead of silently having none.

## v0.632-rc.020826-0958 · 2026-08-02
...
## v0.624-rc.300726-1541 · 2026-07-30

## v0.623-rc.300726-1532 · 2026-07-30

## v0.622-rc.300726-1436 · 2026-07-30

## v0.621-rc.300726-1104 · 2026-07-30

## v0.620-rc.300726-1037 · 2026-07-30

## v0.619-rc.300726-1021 · 2026-07-30

## v0.618-rc.300726-1018 · 2026-07-30

## v0.617-rc.300726-1010 · 2026-07-30

## v0.616-rc.300726-1001 · 2026-07-30

## v0.615-rc.300726-0947 · 2026-07-30

## v0.614-rc.280726-2045 · 2026-07-28

## v0.613-rc.280726-1546 · 2026-07-28
...
## v0.610-rc.280726-1435 · 2026-07-28

## v0.609-rc.280726-1350 · 2026-07-28

## v0.608-rc.280726-1323 · 2026-07-28

## v0.607-rc.280726-1312 · 2026-07-28

## v0.606-rc.280726-1305 · 2026-07-28

## v0.605-rc.280726-1259 · 2026-07-28

## v0.604-rc.280726-1244 · 2026-07-28

## v0.603-rc.280726-1238 · 2026-07-28

## v0.602-rc.280726-1237 · 2026-07-28

## v0.601-rc.280726-1219 · 2026-07-28

## v0.600-rc.280726-1157 · 2026-07-28

## v0.599-rc.280726-0835 · 2026-07-28
...
## v0.595-rc.270726-1938 · 2026-07-27
...
- Fix: A background refresh after finishing an iPod sync could overwrite the "Done" button with stale "Continue" text from the previous screen.
- Fix: The iPod sync screen's title no longer shows a "Sync" prefix and stray dash; it now matches the plain device name shown on the previous step.

## v0.592-rc.270726-1616 · 2026-07-27

## v0.591-rc.270726-1556 · 2026-07-27

## v0.590-rc.270726-1549 · 2026-07-27
...
- Fix: Syncing to a click-wheel iPod now fails fast with one clear message if ffmpeg is missing, instead of a confusing per-track error.
- Fix: Reconciled the license and privacy text shown in-app, in the README, and in the Privacy Policy so contact details, copyright year, and disclosed network requests (including update checks and listening history) match everywhere.

## v0.587-rc.270726-1413 · 2026-07-27

## v0.586-rc.270726-1359 · 2026-07-27

## v0.585-rc.270726-1222 · 2026-07-27

## v0.584-rc.270726-1157 · 2026-07-27

## v0.583-rc.270726-0854 · 2026-07-27

## v0.582-rc.270726-0848 · 2026-07-27

## v0.581-rc.270726-0835 · 2026-07-27

## v0.580-rc.260726-1838 · 2026-07-26
...
- Add: After scanning an iPod in the Sync wizard, its Playlists and Artists (grouped by Album) are browsable in a collapsible accordion, with paging for long lists, and a checkbox on every playlist, artist, album, and song lets you choose what to keep on the device. Continuing takes you to a dedicated sync step that adds anything missing and removes anything you unchecked, in one pass.
...
## v0.572-rc.250726-1036 · 2026-07-25
...
- Fix: Multi-genre tracks no longer count multiple times in library match weighting and coverage percentages.

## v0.563-rc.190726-0925 · 2026-07-19

## v0.562-rc.180726-1928 · 2026-07-18
...
## v0.560-rc.180726-1317 · 2026-07-18

## v0.559 · 2026-07-18

## v0.558-rc.300626-1147 · 2026-06-30

## v0.557-rc.300626-1055 · 2026-06-30

## v0.556-rc.300626-1048 · 2026-06-30

## v0.555-rc.300626-1030 · 2026-06-30
...
## v0.553-rc.270626-0849 · 2026-06-27

## v0.552 · 2026-06-27

## v0.551-rc.270626-0003 · 2026-06-27

## v0.550-rc.260626-2355 · 2026-06-26

## v0.549-rc.260626-2333 · 2026-06-26

## v0.548-rc.260626-2312 · 2026-06-26

## v0.547-rc.260626-2301 · 2026-06-26

## v0.546-rc.260626-2247 · 2026-06-26

## v0.545-rc.260626-2222 · 2026-06-26

## v0.544-rc.260626-1855 · 2026-06-26
...
## v0.541-rc.260626-1502 · 2026-06-26

## v0.540-rc.260626-1452 · 2026-06-26

## v0.539-rc.260626-1441 · 2026-06-26

## v0.538-rc.260626-1435 · 2026-06-26

## v0.537-rc.260626-1420 · 2026-06-26

## v0.537-rc.260626-1416 · 2026-06-26

## v0.536-rc.260626-1409 · 2026-06-26
...
- Remove: Cover Flow toggle removed from Settings — use the Albums toolbar button instead

## v0.531-rc.260626-1320 · 2026-06-26

## v0.530-rc.260626-1310 · 2026-06-26

## v0.529-rc.260626-1016 · 2026-06-26

## v0.528-rc.260626-0940 · 2026-06-26

## v0.527-rc.260626-0921 · 2026-06-26

## v0.526-rc.260626-0909 · 2026-06-26

## v0.525-rc.260626-0846 · 2026-06-26
...
## v0.520-rc.250626-2118 · 2026-06-25

## v0.519-rc.250626-2059 · 2026-06-25

## v0.518-rc.250626-2051 · 2026-06-25

## v0.517-rc.240626-1338 · 2026-06-24

## v0.516-rc.240626-1332 · 2026-06-24

## v0.515-rc.240626-1322 · 2026-06-24
...
## v0.511-rc.230626-1358 · 2026-06-23

## v0.510-rc.230626-1011 · 2026-06-23

## v0.509-rc.230626-0838 · 2026-06-23
...
## v0.501-rc.220626-1553 · 2026-06-22

## v0.500-rc.220626-1128 · 2026-06-22

## v0.499-rc.220626-1113 · 2026-06-22

## v0.498-rc.220626-0949 · 2026-06-22

## v0.497-rc.220626-0833 · 2026-06-22

## v0.496-rc.200626-1449 · 2026-06-20

## v0.495-rc.200626-1439 · 2026-06-20

## v0.494-rc.200626-1431 · 2026-06-20

## v0.493-rc.200626-1423 · 2026-06-20

## v0.492-rc.200626-1414 · 2026-06-20

## v0.491-rc.200626-1359 · 2026-06-20

## v0.490-rc.200626-0919 · 2026-06-20

## v0.489-rc.200626-0854 · 2026-06-20

## v0.488-rc.200626-0848 · 2026-06-20

## v0.487-rc.200626-0841 · 2026-06-20

## v0.486-rc.200626-0839 · 2026-06-20

## v0.485-rc.200626-0823 · 2026-06-20

## v0.484-rc.200626-0810 · 2026-06-20

## v0.483-rc.190626-1738 · 2026-06-19
...
## v0.478-rc.190626-1618 · 2026-06-19
...
## v0.474-rc.180626-1656 · 2026-06-18

## v0.473-rc.180626-1651 · 2026-06-18

## v0.472 · 2026-06-18

## v0.471-rc.180626-1306 · 2026-06-18

## v0.470-rc.180626-1142 · 2026-06-18

## v0.469-rc.180626-1100 · 2026-06-18
...
## v0.464-rc.100626-1254 · 2026-06-10

## v0.463-rc.100626-0922 · 2026-06-10

## v0.462-rc.100626-0847 · 2026-06-10

## v0.461-rc.100626-0825 · 2026-06-10

## v0.460-rc.100626-0816 · 2026-06-10
...
## v0.450-rc.310526-1544 · 2026-05-31

## v0.449 · 2026-05-31

## v0.448-rc.310526-1051 · 2026-05-31

## v0.447-rc.310526-1031 · 2026-05-31

## v0.446 · 2026-05-31

## v0.445-rc.310526-1011 · 2026-05-31

## v0.444-rc.310526-1005 · 2026-05-31
