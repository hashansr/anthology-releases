...
Anthology is a local music manager for macOS built for people who care about their music collection. Browse your local music library by artist and album, build and export playlists to portable audio players, and listen in-app with a real-time parametric EQ. Everything runs on your Mac. No accounts, no cloud, no subscriptions.

---

## Download

**[Download Anthology for macOS →](https://github.com/hashansr/anthology-releases/releases/latest/download/Anthology-latest.dmg)**

- Requires Apple Silicon Mac (M1, M2, M3, or M4). Intel Macs are not supported.
- macOS 14 Sonoma (only tested in macOS 14 Sonoma, may work in older macOS verstions) or later

---

## What You Can Do

<img src="assets/screenshots/app-home.png" alt="Anthology home screen" width="680">
...
Download `Anthology-latest.dmg` using the link above. Once downloaded, double click it to mount the disk image.

<!-- SCREENSHOT: DMG window showing Anthology.app and the Applications folder shortcut -->

### 2. Drag Anthology to Applications

Drag **Anthology** into the **Applications** shortcut in the same window. Wait for the copy to finish, then eject the disk image.

### 3. macOS Security Workaround

Anthology is distributed outside the Mac App Store and is not notarised by Apple, so macOS will block it the first time you open it. This is expected. Follow either method below.

#### Privacy & Security settings

If you double-clicked Anthology and macOS showed a warning, you'll see a dialog like this:
...
3. Find the message **"Anthology.app was blocked to protect your Mac"**
4. Click **Open Anyway**

![Privacy & Security, Open Anyway button](assets/screenshots/privacy-security-open-anyway.jpg)

Anthology will open after a brief verification. You only need to do this once.
...
> **"Anthology would like to access files in your Documents folder."**

Click **Allow**. This permission is required for Anthology to read your music library.
...
Click **Rescan Library**. Anthology will index all tracks and cache metadata. A progress bar shows the scan status. This takes a minute or two on first run depending on library size.
...
Anthology expects your music organised like this:
...
Anthology runs entirely on your Mac. No usage data, analytics, or personal information is ever collected or transmitted to any service.

Depending on which features you enable, Anthology may connect to the following external services to fetch information. All connections are pull-only. Nothing from your library is sent or published.
...
| [GitHub](https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement) | Version check for updates | Periodically, in the background |

Some services (such as Last.fm and Fanart.tv) require you to provide your own API key before Anthology will connect to them. None of these connections happen automatically without your configuration.
...
Anthology is a free, personal project built and maintained in spare time. If it has made your music library a bit more enjoyable, a coffee is always appreciated.
...
Copyright © 2025-2026 Hashan Ranatunga. All Rights Reserved.
